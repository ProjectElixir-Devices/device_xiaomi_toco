...
git clone --depth=1 https://github.com/ProjectElixir-Devices/device_xiaomi_sm6150-common-toco.git -b UNO device/xiaomi/sm6150-common
git clone --depth=1 https://github.com/LineageOS/android_hardware_xiaomi.git -b lineage-21 hardware/xiaomi
git clone --depth=1 https://github.com/vantoman/kernel_xiaomi_sm6150.git -b 14 kernel/xiaomi/sm6150
git clone --depth=1 https://gitlab.com/PixelOS-Devices/playgroundtc.git -b 17 prebuilts/clang/host/linux-x86/clang-playground
git clone --depth=1 https://github.com/AndroidHQ254/vendor_xiaomi.git -b udc vendor/xiaomi
